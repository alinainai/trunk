 ...
 */
public abstract class VideoBaseAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public VideoBaseAdapter(Context context, List<T> datas, boolean isOpenLoadMore) {
        mContext = context;
