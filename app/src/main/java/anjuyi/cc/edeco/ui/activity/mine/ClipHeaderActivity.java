...
import anjuyi.cc.edeco.util.BitmapUtil;
import anjuyi.cc.edeco.view.ClipView;
...
public class ClipHeaderActivity extends BaseActivity implements OnTouchListener {
    ...
    private static final String TAG="ClipHeaderActivity";
    ...
    @OnClick({R.id.iv_back, R.id.src_pic, R.id.fab})
