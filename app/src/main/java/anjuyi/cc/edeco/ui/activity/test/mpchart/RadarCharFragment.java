 ...
 */
public class RadarCharFragment extends BaseFragment {
    ...
    public static RadarCharFragment newInstance(String tag) {
        RadarCharFragment fragment = new RadarCharFragment();
