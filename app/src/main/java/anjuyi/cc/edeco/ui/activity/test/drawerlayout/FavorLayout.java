...
/**
 * http://www.jcodecraeer.com/a/anzhuokaifa/androidkaifa/2015/0620/3092.html
 * 作者：Mr.Lee on 2016-10-21 09:36
 * 邮箱：569932357@qq.com
 */
...
public class FavorLayout extends RelativeLayout {
    ...
    private  void init(){dHeight=50;

        drawables = new Drawable[3];
        red = getResources().getDrawable(R.mipmap.flower_1);
        yellow = getResources().getDrawable(R.mipmap.flower_3);
        blue = getResources().getDrawable(R.mipmap.flower_2);
        //赋值给drawables
        drawables[0]=red;
        drawables[1]=yellow;
        drawables[2]=blue;
