...
public class LineCharFragment extends BaseFragment {
    ...
    public static LineCharFragment newInstance(String tag) {
        LineCharFragment fragment = new LineCharFragment();
    ...
    //    mv.setChartView(mChart); // For bounds control
     //   mChart.setMarker(mv); // Set the marker to the chart
        ...
        LimitLine ll1 = new LimitLine(120f, "Upper Limit");
        ll1.setLineWidth(2f);
